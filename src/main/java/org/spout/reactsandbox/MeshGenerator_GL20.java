 ...
 */
public class MeshGenerator_GL20 {
	/**
	 ...
	 */
	public static OpenGL20Model generateWireCuboid(Vector3 size) {
		/*
		^
		| y
		|
		...
		// Model data buffers
		final OpenGL20Model model = new OpenGL20Model();
	 ...
	 * @param size The size of the cuboid to generate, on x, y and z
	 */
	public static OpenGL20Model generateCuboid(Vector3 size) {
		// Corner positions
		final Vector3 p = Vector3.divide(size, 2);
		final Vector3 p6 = new Vector3(p.getX(), p.getY(), p.getZ());
		final Vector3 p0 = Vector3.negate(p6);
	 ...
	 */
	public static OpenGL20Model generateSphere(float radius) {
	 ...
	 */
	public static OpenGL20Model generateCylinder(float radius, float height) {
	 ...
	 */
	public static OpenGL20Model generateCone(float radius, float height) {
